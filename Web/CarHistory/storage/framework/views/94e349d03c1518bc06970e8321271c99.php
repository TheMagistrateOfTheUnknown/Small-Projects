...
<?php $component->withAttributes([]); ?>
    ...
    <form class="flex flex-col gap-4" action="<?php echo e(route('vehicles.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <label class="text-white" for="nameplate">Nameplate : </label>
        <input type="text" name="nameplate" id="nameplate"  value="<?php echo e(old('nameplate', '')); ?>">
        <?php $__errorArgs = ['nameplate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="text-red-500">NAMEPLATE ERROR: <?php echo e($message); ?></div>
        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <input type="number" name="factoryYear" id="factoryYear" min="1950" max="2023" value="<?php echo e(old('factoryYear', '')); ?>">
...
<?php endif; ?><?php /**PATH C:\UNI\Szerver\Laravel-bead\beadando\resources\views/vehicles/create.blade.php ENDPATH**/ ?>