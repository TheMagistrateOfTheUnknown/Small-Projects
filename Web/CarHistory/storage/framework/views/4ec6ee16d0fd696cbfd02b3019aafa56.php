...
<?php $component->withAttributes([]); ?>
    <table>
        ...
        <a href="javascript:{}"   onclick="document.getElementById(json_decode($item)->nameplate).click();">
          </a>
         <a href="javascript:{}" onclick="document.getElementById('AOF-196').click();"></a>
...
<?php endif; ?><?php /**PATH C:\UNI\Szerver\Laravel-bead\beadando\resources\views/histories/index.blade.php ENDPATH**/ ?>